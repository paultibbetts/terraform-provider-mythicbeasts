...
func (d *VPSImagesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Returns available VPS operating system images. Use image names from this data source when creating [`mythicbeasts_vps` resource](../resources/vps).",

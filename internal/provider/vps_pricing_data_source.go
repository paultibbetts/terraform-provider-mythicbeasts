...
func (d *VPSPricingDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Returns VPS pricing for disk, IPv4, and product codes. Use this to estimate monthly costs before creating or updating [`mythicbeasts_vps` resource](../resources/vps).",
